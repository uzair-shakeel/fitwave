...
const Footer = () => {
  ...
  return (
    <footer className="bg-blackish max-w-[1920px] mx-auto text-white mt-[15px] pb-[15px] overflow-hidden rounded-t-[1.389vw]">
      ...
      <div className="mx-auto flex flex-col md:gap-[0.694vw] gap-[1.465vw] sm:flex-row justify-between px-[15px]">
        <div className="sm:order-1 order-2 bg-[#f9a600] flex flex-grow flex-col text-blackish pt-[15px] rounded-[1.389vw] md:max-w-[27.153vw] sm:min-h-auto min-h-[25vw] sm:max-w-[38.184vw]  min-h-full justify-between">
          <div className="flex flex-col gap-[7px]">
            ...
            <div className="font-[600] sm:text-[2.431vw] text-[4.395vw] max-w-[350px] tracking-[-0.03em] text-[#192227] sm:mt-2 leading-[90%] px-[15px]">
          ...
          <div>
            <div className="text-sm border-y border-[#dd8411] h-[3.819vw] flex items-center">
              <span className="px-[15px] font-[400] md:text-[1.25vw] text-[1.758vw] tracking-[-0.01em]">
                © Runway 2024.
              </span>
            </div>
            <div className="flex gap-[6px] px-[15px] items-center justify-between h-[3.819vw] md:text-[1.25vw] text-[1.758vw] font-[400] leading-[-0.02em]">
              <a
                href="/terms"
                className="flex items-center gap-[3px] hover:underline"
              >
                <IoMdArrowForward className="h-[2.667vw]" /> Terms
              </a>
              <a
                href="/privacy"
                className="flex items-center gap-[3px] hover:underline"
              >
                <IoMdArrowForward className="h-[2.667vw]" /> Privacy
              </a>
              <a
                href="/security"
                className="flex items-center gap-[3px] hover:underline me-[10px]"
              >
                <IoMdArrowForward className="h-[2.667vw]" /> Security
              </a>
            </div>
          </div>
        </div>
        <div className="sm:order-2 order-1 flex flex-grow rounded-[1.389vw] border border-[#fdfcfc] overflow-hidden">
          <ul className="w-full">
            {[
              "Get Access",
              "Log In",
              ...
              >
                <a
                  ...
                  className="md:text-[1.25vw] text-[2.441vw] font-[600] tracking-[-0.03em]"
                >
                  {item}
                </a>
